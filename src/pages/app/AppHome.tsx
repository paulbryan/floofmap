...
const AppHome = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <div className="bg-gradient-to-b from-amber-500/10 to-background px-4 pt-12 pb-6">
        <motion.div
        ...
        >
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 flex items-center justify-center shadow-lg">
              <Dog className="w-8 h-8 text-white" />
            </div>
            <div className="flex-1">
              <h3 className="font-semibold text-lg">Ready for a walk?</h3>
      ...
      <div className="px-4 py-6">
        ...
        >
          <div className="bg-card rounded-xl p-4 border border-border">
            <p className="text-2xl font-bold text-primary">{stats.totalWalks}</p>
            <p className="text-sm text-muted-foreground">Total Walks</p>
          </div>
          <div className="bg-card rounded-xl p-4 border border-border">
            <p className="text-2xl font-bold text-secondary">{stats.totalDistance}</p>
            <p className="text-sm text-muted-foreground">Distance</p>
          </div>
          <div className="bg-card rounded-xl p-4 border border-border">
            <p className="text-2xl font-bold text-accent">{stats.avgSniffs}</p>
